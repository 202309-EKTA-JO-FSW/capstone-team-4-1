  ...
  return (
      <div className="fixed top-0 left-0 w-full z-10">
        <div className="flex firstPiece items-center space-x-2 bg-[#101B0B] sticky">
          <img src="/logo.png" className="w-62 h-20 pl-20 pt-10" alt="logo" />
          <div className="flex justify-end space-x-8 text-[#FFC245] w-full pr-20">
        ...
        <svg className="secondPiece" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 80">
