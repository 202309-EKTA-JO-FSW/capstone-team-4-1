      ...
      <div className="flex flex-row justify-center items-center space-between space-x-[4rem] mt-[2rem]">
        ...
        <div className="flex flex-col">
          <img className="rounded-full w-[200px] h-[200px] mb-8"
           src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=2788&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="person1"/>
          <h2 className="font-bold text-center text-gray-700 text-lg">Sara Malek</h2>
