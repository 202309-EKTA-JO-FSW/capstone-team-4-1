  ...
  return (
    <div>
      <div className="relative w-full h-[600px] overflow-hidden bg-black">
        <img
          className="absolute w-full h-[600px] top-0 left-0 z-0 mt-20 pt-10 bg-black opacity-50"
          src="/backgroundwelcome.png"
          alt="gifwelcome"
        />
        <div className=" absolute w-full h-[600px] flex items-center justify-center z-11">
          <h1 className="font-bold text-6xl text-white text-center pt-10 mt-20">
      ...
      <div className="flex items-center justify-center">
        <h1 className="font-bold text-4xl text-black text-center pt-10">
          Let's do it together
        </h1>
      </div>

      <div className="flex items-center justify-center">
        <h1 className="font-bold text-2xl text-black text-center pt-2">
          Join us!
        </h1>
      </div>
      ...
      <div className="flex justify-center space-x-10 text-black text-center mt-5 mb-10">
        <div className="py-2 font-bold mr-20 pr-10">
          <img
            src="/rider.png"
            class="w-60 h-70 pt-10 mb-5 rounded-full mx-auto"
            alt="rider"
          />
          ...
          <p className="text-sm">
            Enjoy flexibility, freedom and competitive <br /> earnings by
            delivering through FoodDrop.
          </p>
          <button className="bg-[#FFC245] text-black text-center mx-auto mt-5 py-2 px-8 rounded-xl font-bold">
            Register here
          </button>
        </div>
        ...
        <div className="py-2 font-bold ml-20 pl-10">
          ...
          <p className="text-sm">
            Grow with FoodDrop! Our technology <br /> base can help you boost
