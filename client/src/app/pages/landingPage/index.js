    ...
    <div className="relative bg-[#fff] overflow-hidden text-black">
        ...
        <div className="relative w-full overflow-hidden bg-black xl:h-[600px] 
          ...
          xl:mt-10 xl:pt-10 md:mt-8 md:pt-4 mt-4 pt-5
            xl:h-[600px] lg:h-[400px] md:h-[300px] sm:h-[250px] h-[200px]"
             src="/backgroundwelcome.png" alt="gifwelcome" />
            ...
            <h1 className="font-bold text-white text-center
              xl:text-6xl lg:text-4xl md:text-xl sm:text-lg text-md
               xl:pt-10 lg:pt-4 sm:pt-2 pt-4 xl:mt-10 lg:mt-10 sm:mt-6 mt-4">
                Order food online in Jordan</h1>

          </div>
        </div>

        <svg className="relative xl:-mt-12 lg:-mt-8 md:-mt-6 sm:-mt-4 2xs:-mt-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 80">
        ...
        <div className="flex justify-center text-black text-center
         ...
         ">     
            ...
            "> 
              <img src="/rider.png" className="rounded-full mx-auto
              ...
              ">Enjoy unmatched, unparalleled flexibility, freedom, <br />and highly competitive earnings <br />by delivering through FoodDrop today.</p>
              <button className="bg-[#FFC245] hover:bg-[#B92719] text-black text-center mx-auto rounded-xl font-bold border-transparent hover:border-black
            ...
            2xs:py-1 2xs:ml-2 2xs:pl-2"> 
              ...
              <img src="/restaurant.jpg" className="rounded-full mx-auto
              xl:w-60 xl:h-70 xl:pt-10 xl:mb-5
              md:w-[150px] md:h-auto md:pt-8 md:mb-4
              sm:w-[100px] sm:h-auto sm:pt-4 sm:mb-2
              2xs:w-[100px] 2xs:h-auto 2xs:pt-2 2xs:mb-1
              ...
              <p className="
                ...
                break-words
                ">Grow with FoodDrop! Embrace our cutting-edge <br />technology to boost your sales <br />and explore new opportunities now!</p>
