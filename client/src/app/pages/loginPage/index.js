...
export default function LoginPage({ onClose }) {
  ...
  const clientId =
    "63738745837-k81ls7845ijo98r0k1bk2ktoema1akf0.apps.googleusercontent.com";

  return (
    <GoogleOAuthProvider clientId={clientId}>
      <div className="fixed inset-0 bg-gray-600 bg-opacity-50 z-50 overflow-y-auto h-full w-full">
        <div
          className="relative mx-auto border w-[650px] shadow-lg rounded-3xl bg-white
      ...
      "
        ...
        "
          ...
          <div className="mt-3 text-center">
            <h2
              className="leading-6 font-medium text-black
          ...
          xl:mt-8 md:mt-5 2xs:mt-3"
            >
              <div className="flex justify-center">
                {submitFail && (
                  <p className="text-[#FFC245] text-lg">
              ...
              <div className="flex justify-between items-center mt-4">
                <a
                  href="#"
                  className="font-bold text-[#FFC245] hover:text-[#101B0B]
              xl:text-sm
              md:text-[12px]
              2xs:text-[8px]
              "
            ...
            <div
              className="xl:mb-5 md:mb-4 2xs:mb-3
