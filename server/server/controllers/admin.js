  ...
  removeRestaurant: async (req, res) => {
    ...
    try {
      ...
      if (!deletedRestaurant) {
        ...
        res.status(204).json({ message: "The restaurant was deleted" });
      }
    } catch (err) {
      res.status(422).json({ message: err.message });
    }
  ...
  removeRider: async (req, res) => {
    ...
    try {
      ...
      if (!deletedRider) {
        ...
        res.status(204).json({ message: "The rider was deleted" });
      }
    } catch (err) {
      res.status(422).json({ message: err.message });
    }
  ...
  removeOrder: async (req, res) => {
    ...
    try {
      ...
      if (!deletedOrder) {
        ...
        res.status(204).json({ message: "The order was deleted" });
      }
    } catch (err) {
      res.status(422).json({ message: err.message });
    }
